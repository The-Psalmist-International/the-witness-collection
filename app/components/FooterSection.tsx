        ...
        <div className="flex flex-wrap gap-12 md:gap-24 lg:gap-32">
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4">
              <Link href="#" className="text-sm text-neutral-300 hover:text-white transition-colors">TikTok</Link>
              <Link href="#" className="text-sm text-neutral-300 hover:text-white transition-colors">Instagram</Link>
            </div>
          </div>

          <div className="flex flex-col gap-6">
            <h4 className="text-xs font-semibold tracking-wider text-neutral-400 uppercase">Resources</h4>
            <div className="flex flex-col gap-4">
              <Link href="#" className="text-sm text-neutral-300 hover:text-white transition-colors">Home</Link>
              <Link href="#" className="text-sm text-neutral-300 hover:text-white transition-colors">Shop</Link>
              <Link href="#" className="text-sm text-neutral-300 hover:text-white transition-colors">Blog</Link>
            </div>
          </div>

          <div className="flex flex-col gap-6">
            <h4 className="text-xs font-semibold tracking-wider text-neutral-400 uppercase">Company</h4>
            <div className="flex flex-col gap-4">
              <Link href="#" className="text-sm text-neutral-300 hover:text-white transition-colors">About</Link>
              <Link href="#" className="text-sm text-neutral-300 hover:text-white transition-colors">Support</Link>
            </div>
          </div>
        </div>
      </div>
