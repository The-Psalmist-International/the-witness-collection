...
import { toggleDiscountActive } from "@/app/admin/actions";
          ...
          <tbody>
            {discounts.length === 0 ? (
              ...
              discounts.map((discount) => (
                <tr key={discount.id} className="border-b border-neutral-100 last:border-b-0">
                  <td className="px-4 py-4 font-medium text-black">{discount.name}</td>
